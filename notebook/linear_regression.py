...
x['sqft_living'] = normalization(x['sqft_living'])
x['bathrooms'] = normalization(x['bathrooms'])
x['sqft_above'] = normalization(x['sqft_above'])
x['sqft_living15'] = normalization(x['sqft_living15'])
